class Forca {
  ...
  obterPalavraSecreta() {
    const palavras = [
      "ABACATE", "ABACAXI", "ACEROLA", "ACAI", "ARAÇA", "ABACATE", "BACABA", 
      "BACURI", "BANANA", "CAJA", "CAJU", "CARAMBOLA", "CUPUAÇU", "GRAVIOLA", 
      "GOIABA", "JABUTICABA", "JENIPAPO", "MAÇA", "MANGABA", "MANGA", "MARACUJA", 
